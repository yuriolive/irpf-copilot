...
/*     */ 
/*     */ public class PainelMensagemDoacaoExcedidaECA extends JPanel {
/*     */   private JButton jButton1;
/*     */   private JPanel jPanel2;
/*     */   
/*     */   public PainelMensagemDoacaoExcedidaECA() {
/*     */     String dataFimRecepcao;
/*  28 */     initComponents();
/*     */     
/*  30 */     Valor totDoacoes = new Valor();
/*  31 */     Valor limite = new Valor();
/*  32 */     totDoacoes.setConteudo(ControladorGui.getDemonstrativoAberto().getColecaoEstatutoCriancaAdolescente().getTotalDeducaoIncentivoBruto());
/*  33 */     limite.setConteudo(totDoacoes);
/*  34 */     limite.append('+', ControladorGui.getDemonstrativoAberto().getColecaoEstatutoCriancaAdolescente().getValorDisponivelDoacao());
...
/*     */     
/*  43 */     this.lblMensagemP1.setText(MensagemUtil.getMensagem("doacoes_eca_popup_excede_limite_doacao_p1", new String[] { TabelaAliquotasIRPF.ConstantesAliquotas.deducoesIncECA.getValor().formatado().substring(0, 1), 
...
/*     */     } 
/*     */     
/*  54 */     this.lblMensagemP2.setText(MensagemUtil.getMensagem("doacoes_eca_popup_excede_limite_doacao_p2", new String[] { limite.toString(), totDoacoes
...
/*  75 */     setPreferredSize(new Dimension(700, 470));
/*     */     
...
/*  84 */             PainelMensagemDoacaoExcedidaECA.this.jButton1ActionPerformed(evt);
/*     */           }
/*     */         });
...
/* 136 */           .addComponent(this.jPanel2, -1, 38, 32767)
/* 137 */           .addGap(18, 18, 18)));
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\Arquivos de Programas RFB\IRPF2025\lib-modulos\irpf_gui-declaracao.jar!\serpro\ppgd\irpf\gui\doacaodiretamentedeclaracao\PainelMensagemDoacaoExcedidaECA.class
