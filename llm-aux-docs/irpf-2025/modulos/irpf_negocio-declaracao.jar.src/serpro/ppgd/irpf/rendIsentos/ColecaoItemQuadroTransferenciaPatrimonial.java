...
/*    */ 
/*    */ public class ColecaoItemQuadroTransferenciaPatrimonial extends Colecao<ItemQuadroTransferenciaPatrimonial> {
...
/* 25 */     itemQuadroTransferenciaPatrimonial.getValor().addObservador((Observador)this);
/* 26 */     calculaTotal();
/*    */   }
/*    */ 
/*    */   
/*    */   public void objetoRemovido(Object o) {
/* 31 */     ((ItemQuadroTransferenciaPatrimonial)o).getValor().removeObservador((Observador)this);
/* 32 */     calculaTotal();
/*    */   }
/*    */   
/*    */   private void calculaTotal() {
/* 36 */     Iterator<ItemQuadroTransferenciaPatrimonial> it = itens().iterator();
/* 37 */     this.totais.clear();
/* 38 */     while (it.hasNext()) {
/* 39 */       ItemQuadroTransferenciaPatrimonial itemQuadroAuxiliar = it.next();
...
/*    */     }
/*    */     
/* 55 */     Iterator<ItemQuadroTransferenciaPatrimonial> it = itens().iterator();
/* 56 */     while (it.hasNext()) {
/* 57 */       ItemQuadroTransferenciaPatrimonial item = it.next();
/*    */       
...
/* 70 */     Iterator<ItemQuadroTransferenciaPatrimonial> it = itens().iterator();
/* 71 */     while (it.hasNext()) {
/* 72 */       ItemQuadroTransferenciaPatrimonial item = it.next();
/*    */       
...
/* 83 */     return new ItemQuadroTransferenciaPatrimonial(this.dec.get());
/*    */   }
/*    */   
...
/* Location:              C:\Arquivos de Programas RFB\IRPF2025\lib-modulos\irpf_negocio-declaracao.jar!\serpro\ppgd\irpf\rendIsentos\ColecaoItemQuadroTransferenciaPatrimonial.class
